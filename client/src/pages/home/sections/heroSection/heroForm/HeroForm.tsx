...
import { useCreateProjectStore } from '@/features/project/create/store/useStore';
import { isValidZip } from '@/features/project/create/utils/isValidZip';
...
const HeroForm = () => {
    ...
    const { project, setProject } = useCreateProjectStore();
